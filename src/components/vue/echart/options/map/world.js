...
export const getWorldMap1Option = () => {
    return {
        backgroundColor: new vue.$echarts.graphic.RadialGradient(0.5, 0.5, 0.4, [
            {
                offset: 0,
                color: "#4b5769"
            },
        ...
        tooltip: {
            ...
            formatter: function(params) {
                var value = String(params.value).split(".");
